-- get_portal_proposal: expõe as solicitações de fornecimento ABERTAS
-- ('execution_requests') pro cliente ver "aguardando confirmação" no detalhe
-- do pedido recorrente (20/ago/2026 — complemento da migration
-- 20260820210000_umbrella_execution_requests).
