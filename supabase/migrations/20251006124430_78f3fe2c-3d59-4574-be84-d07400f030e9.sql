-- Fix process_inventory_adjustment to use valid reference_type per stock_movements constraint
...
BEGIN
  ...
  IF v_quantity_diff != 0 THEN
    ...
    -- Create stock movement record for audit trail using allowed values
