-- Fix process_inventory_adjustment to not insert into generated column
...
BEGIN
  ...
  -- Create inventory adjustment record WITHOUT quantity_difference (it's a generated column)
