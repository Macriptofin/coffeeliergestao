-- create_portal_order ainda validava item por item contra client_catalog_items
-- (removida na migration portal_catalog_global_flag_instead_of_curation) —
-- corrige pra validar pelos mesmos critérios de get_portal_catalog: vendável,
-- não arquivado, is_portal_visible=true. Sem isso, TODO envio de pedido quebrava.
