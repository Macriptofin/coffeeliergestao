-- ============================================================
-- RELATÓRIOS E INVENTÁRIO DE ESTOQUE - FASE 1
...
-- Policies para inventory_cycles
...
-- Atualizar policies de inventory_adjustments (já existem, só garantir que funcionam com cycle_id)
-- As policies existentes já cobrem, não precisa alterar