-- Fix process_inventory_adjustment to set is_draft = false for direct adjustments
-- This ensures the stock is updated immediately when not using inventory cycles
...
BEGIN
  ...
  -- Create inventory adjustment record with is_draft = false for direct adjustments
  INSERT INTO public.inventory_adjustments (
    ...
    auth.uid(),
    p_notes,
    false  -- Direct adjustments are not drafts
...
-- Also fix the existing draft adjustment that was just made
UPDATE public.inventory_adjustments 
SET is_draft = false 
WHERE id = '3a5af2a0-1138-40ca-94fa-378925971af7';

-- Update the stock for that material
UPDATE public.stock_items 
SET current_quantity = 16, updated_at = now() 
WHERE material_id = '7a65dc18-0906-4542-9b7f-132e0ce513e5';