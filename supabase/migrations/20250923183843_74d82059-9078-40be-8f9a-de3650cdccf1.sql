-- Remover função antiga e criar nova com material_id
DROP FUNCTION IF EXISTS public.calculate_weighted_average_price(uuid, numeric, numeric);

-- Criar função atualizada para usar material_id
...
BEGIN
  ...
  IF current_stock IS NULL THEN
    ...
    VALUES (p_material_id, p_new_quantity, p_new_price, p_new_quantity * p_new_price);
    RETURN p_new_price;
  END IF;
