...
-- Remover função antiga e recriar
...
BEGIN
  ...
  ELSE
    ...
    v_new_total_value := p_new_unit_cost * v_stock_item.current_quantity;
  ...
  -- Inserir registro de ajuste (SEM cost_difference - é coluna gerada)
  INSERT INTO cost_adjustments (
    ...
    v_old_unit_cost,
    p_new_unit_cost,
    COALESCE(v_stock_item.current_quantity, 0),
    v_old_total_value,
    v_new_total_value,
    p_adjustment_reason,
...
'Processa ajuste manual de custo de material, atualiza stock_items, registra em cost_adjustments e propaga mudanças para BOMs';
