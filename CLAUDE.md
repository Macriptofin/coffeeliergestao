...
- **Pendências desta frente** (set/2026): identidades de PF/PJ sem regra (ZOOP, PIX Marketplace, Jackeline, Eder, Luiza, Ação Produções, Amanda Freischlag, Roselene, Claudia Chacon, Noeli Brass, Jefferson Venâncio, Luciano Gurniak, Fernanda Biavatti, Geneci, Rodrigo Menezes, Maiquelem, Airton de Conti, Fabrício Bicca, Milene, Leonelo, Antonio Cabreira, Vedere/FNS); 15 AR manuais sem NF (R$ ~86k, todas "Vencido" — decidir cancelar/manter); 4 Pix CMPC sem par (2.848, 380, 210, 616 — a última classificada como receita avulsa pelo usuário); taxa da maquininha só com o relatório de vendas da InfinityPay (senão entra pelo líquido); linha Evandro −80 (04/09) classificada em 2.1.1.001 (passivo) por engano; classificação em massa das ~1.500 linhas pendentes (a maioria já com sugestão).
