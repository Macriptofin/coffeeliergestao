      ...
      <div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Acesso restrito para proteção de dados empresariais
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Alert className="border-amber-200 bg-amber-50">
              ...
              <AlertDescription className="text-amber-800">
                <strong>Acesso Restrito:</strong> Esta seção contém informações confidenciais de fornecedores, incluindo dados fiscais (CNPJ/CPF), contatos comerciais e endereços. O acesso é limitado a usuários com permissões de administrador ou gerente para proteger essas informações sensíveis contra acesso não autorizado.
              </AlertDescription>
            </Alert>
          </CardContent>
        </Card>
