        ...
        <Suspense fallback={<PageLoader />}>
          <Routes>
            ...
            <Route path="/" element={<Layout />}>
              ...
              {/* Rotas legadas (pré-unificação BOM/Receitas, jun/2026) — redirecionam permanentemente */}
              <Route path="receitas" element={<Navigate to="/producao/fichas-tecnicas" replace />} />
              <Route path="producao/bom" element={<Navigate to="/producao/fichas-tecnicas" replace />} />
              <Route path="producao/calculo-custos" element={<Navigate to="/producao/relatorios?tab=costs" replace />} />
